...
import { setValidatedActiveOrg, syncOrganizations } from "../org";
import { orgStorage } from "../storage";
import type { OrganizationDetail, OrganizationSummary } from "@/shared/types/organization";
...
export default function DashboardShell({ children, title, subtitle }: DashboardShellProps) {
  ...
  const handleOrgSwitch = async (event: React.ChangeEvent<HTMLSelectElement>) => {

...
import type { SessionSummary } from "@/shared/types/auth";
...
type BulkAction = "others" | "all" | null;
...
export default function Settings() {
  ...
  return (
    <AppShell title="Settings" subtitle="Manage security preferences for your account.">
      {alert && (
        <div className="mb-6">

...
export default function AssetLifecycleActions({ projectId, asset, onChanged }) {
  ...
  const confirmDelete = () => {
    if (window.confirm(`Delete "${asset.name}"? This soft-deletes the asset and preserves scan history.`)) {
      run("delete", "delete");
    }
  };

...
export default function AssetViewToggle({ mode, onChange, treeAvailable }) {
  return (
    <div className="flex items-center gap-1 rounded-lg border border-brand-800/50 p-1">
      <button
        ...
        title={treeAvailable ? "Paginate root assets and expand children" : "Tree view unavailable while searching or filtering child types"}
      >
        <ListTree size={16} />
        Tree
      </button>

...
export default function AssetCreateForm({ projectId, parentAssets, onCreated }) {
  ...
  const isServerType = form.type === "server";
  ...
  const parentOptions = useMemo(
    () => parentAssets.filter((asset) => asset.type === requiredParentType),
    [parentAssets, requiredParentType],
  );

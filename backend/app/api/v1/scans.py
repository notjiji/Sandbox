...
def list_scans(
    ...
    result = scan_service.list_project_scans(
...
def create_scan(
    ...
    scan = scan_service.create_project_scan(
...
def get_scan(
    ...
    scan = scan_service.get_project_scan(
        db, membership, project_id=project_id, scan_id=scan_id
    )
...
def run_scan(
    ...
    scan = scan_service.run_project_scan(
        db, membership, project_id=project_id, scan_id=scan_id
    )
    return success_response(data=scan.model_dump(mode="json"))
...
def cancel_scan(
    ...
    scan = scan_service.cancel_project_scan(
        db, membership, project_id=project_id, scan_id=scan_id
    )
    return success_response(data=scan.model_dump(mode="json"))

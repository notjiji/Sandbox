...
| [storage.md](./storage.md) | Durable PDF/HTML storage (local volume or S3) |
...
4. Worker collects findings, builds `ReportData`, generates AI summary, renders HTML, converts to PDF, persists via [report storage](./storage.md).

...
| ID | Requirement | Kind | Notes |
|----|-------------|------|-------|
| **NFR-AVL-14** | There is **no** in-repo backup job, PITR, or restore procedure. Volume loss is data loss unless the operator adds backups outside this repository. | Explicitly unspecified | Documented limitation. |
